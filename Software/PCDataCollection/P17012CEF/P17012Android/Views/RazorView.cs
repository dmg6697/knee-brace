...
public P17012Android.Models.Model1 Model { get; set; }
...
WriteLiteral(" src=\"Scripts/jquery-3.1.1.js\"");

WriteLiteral("></script>\r\n    <script");

WriteLiteral(" type=\"text/javascript\"");

WriteLiteral(" src=\"Scripts/main.js\"");
...
WriteLiteral(@">
        ...
        function InvokeCSharpWithFormValues(elm) {
            ...
            var context = document.getElementById('kp_canvas').getContext();
...
WriteLiteral(" id=\"kp_canvas\"");

WriteLiteral(">no render</canvas>\r\n\r\n                <input");
